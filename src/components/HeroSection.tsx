...
const HeroSection = () => {
  ...
  return <section className={`relative min-h-screen flex items-center justify-center pt-16 ${theme === 'dark' ? 'bg-gray-900' : ''}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-center">
          <div className="lg:w-3/5 flex flex-col items-start text-left">
            <h1 className={`font-display text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-6`}>
            ...
            <p className={`text-lg md:text-xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-10`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button onClick={scrollToRegistration} className="bg-blue-600 hover:bg-blue-700 px-8 py-6 rounded-full text-white transition-colors" size="lg">
                Join Early Access
              </Button>
              
              <Button onClick={navigateToDemoApp} variant="outline" className={`${theme === 'dark' ? 'border-gray-700 text-gray-200 hover:bg-gray-800' : 'border-gray-300 text-gray-800 hover:bg-gray-50'} px-8 py-6 rounded-full transition-colors`} size="lg">
