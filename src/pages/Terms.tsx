  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 pt-24">
        <h1 className="text-3xl font-bold mb-6 font-display tracking-tight text-gray-900">Terms of Use</h1>
        <div className="prose max-w-none">
          <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">Acceptance of Terms</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">Demo Version Limitations</h2>
          <p className="text-gray-600">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">User Obligations</h2>
          <p className="text-gray-600">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">Intellectual Property</h2>
          <p className="text-gray-600">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">Limitation of Liability</h2>
          <p className="text-gray-600">
